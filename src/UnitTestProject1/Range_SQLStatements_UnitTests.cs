...
namespace UnitTestProject1
{
   ...
   [Category("Unit")]
    ...
    public class Range_SQLStatements_UnitTests : SQLLogStatements_Helper
    {
        ...
        [Test]
        [ExpectedException(typeof(ArgumentException),"StartRange argument '22' is invalid format for cell name")]
        ...
        [Test]
        [ExpectedException(typeof(ArgumentException),"EndRange argument 'DD' is invalid format for cell name")]
